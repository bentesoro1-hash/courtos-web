export default function Footer() {
  ...
  return (
    <footer className="border-t border-court-border bg-court-bg">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-slate-500 text-sm mb-4 leading-relaxed">
              The Coaching OS for Volleyball
            </p>
            <div className="space-y-1.5">
              <a
                href="https://courtos.co"
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="#beta" className="text-slate-400 hover:text-white text-sm transition-colors">
                  Beta Program
                </a>
              </li>
              <li>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                ...
                >
                  {/* TikTok icon */}
                  <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V9.26a8.2 8.2 0 004.79 1.52V7.32a4.85 4.85 0 01-1.02-.63z" />
                  </svg>
                  TikTok
                </a>
              </li>
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-court-border flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-600 text-sm">
            © {year} CourtOS. All rights reserved.
          </p>
